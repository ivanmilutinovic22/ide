...
type Theme struct {
	...
	SelectedFG  string
	SelectedBG  string
	SelectionBG string // soft wash painted behind selected list rows; subtler than SelectedBG
	Active      string
	Inactive    string
	Accent      string
	Muted       string
...
func Normalize(t Theme) Theme {
	...
	t.SelectionBG = strings.TrimSpace(t.SelectionBG)
